...
**Biological databases** are a way for scientists to organize and share their data.  Most of this data is publicly available, if you know how to look.  We’ll take a quick look at some important biological databases to give you an idea of what’s out there.
...
Here is the entry for [CFTR](https://www.omim.org/entry/602421), from the [Online Mendelian Inheritance in Man (OMIM)](https://www.omim.org/) database.  Mutations in CFTR lead to cystic fibrosis:
