...
- A **protein** is an **amino acid** sequence.  Proteins fold up into specific shapes that let them do their jobs.  Proteins are the workhorses of the cell, they perform most cellular functions in living organisms.  Proteins do things like:
    - Carry out chemical reactions
    - Move materials around inside the cell
    - Transport things in and out of a cell
