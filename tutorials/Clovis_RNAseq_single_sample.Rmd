...
3. Use R to analyze HTSeq files
4. Create and analyze histograms from HTSeq files
...
Histograms are good way to get a preliminary look at RNA-seq data.  Because RNA-seq data has such wide-ranging values, it is often plotted on a log scale.  A histogram can give us an idea of the shape of our data:
