---
title: "Biotechnology Resources: Next-Gen Sequencing"
output:
  learnr::tutorial:
    css: css/cmoor.css
    progressive: true
...
Sequencing reads are a bit like having short phrases (reads) from a whole book (the genome).  In order to understand what they mean, we need to find where in the book they came from.


### Counting

Perhaps the most common type of sequencing analysis involves counting the number of reads that come from particular genes (or pther regions of the genome).
