...
## Investigating Genes on FlyBase
...
Go to [FlyBase](http://flybase.org), and enter `FBgn0000024` in the search bar ("Jump to Gene").

![](assets/images/FlyBase_home.png){width=100%}
